...
class CapillaCentralPage extends StatefulWidget {
  const CapillaCentralPage({super.key});

  @override
  State<CapillaCentralPage> createState() => _CapillaCentralPageState();
}
...
class _CapillaCentralPageState extends State<CapillaCentralPage> {
  ...
  Future<void> _cargarBloques() async {
    final raw = await rootBundle.loadString('assets/data/capilla_central.json');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Capilla Central'),
      ),
...
class _FooterCTA extends StatelessWidget {
  ...
  static final _whatsappUrl =
      'https://wa.me/${AppConfig.petitionsPhone}?text=Hola%2C%20quiero%20dejar%20una%20petici%C3%B3n%20para%20la%20Santa%20Misa%20%F0%9F%99%8F';
