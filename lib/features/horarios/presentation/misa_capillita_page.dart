...
class MisaCapillitaPage extends StatefulWidget {
  const MisaCapillitaPage({super.key});

  @override
  State<MisaCapillitaPage> createState() => _MisaCapillitaPageState();
}
...
class _MisaCapillitaPageState extends State<MisaCapillitaPage> {
  ...
  Future<void> _cargarBloques() async {
    final raw = await rootBundle.loadString('assets/data/misa_capillita.json');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Misa en la Capillita'),
      ),
